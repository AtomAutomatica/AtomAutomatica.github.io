...
def money_b():
    return [
        ...
        table(['Question', 'Answer', 'Source'], [
            ...
            ['Unemployment insurance?', 'Covered. Texas excludes only the employer\'s spouse, a parent employed by a child, and a child under 21 employed by a parent. A daughter is covered. If the job ends (nursing-home placement, death), file with TWC 800-939-6631.', 'Tex. Labor Code 201.065'],
