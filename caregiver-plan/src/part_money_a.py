...
def money_a():
    return [
        ...
        bullets([
            ...
            '<b>Any private pay to the cousin before Medicaid starts</b> must be under a written, prospective Personal Care Agreement at a fair hourly wage for genuine personal care (bathing, toileting, transfers), paid by check, with daily logs. Texas treats payment for "chores a family member would normally do" (cleaning, laundry, meals, shopping, driving) as a gift even with a contract (MEPD I-4140).',
        ]),
        H2('6.3 Protecting the house from Medicaid Estate Recovery (MERP)'),
        P('Texas recovers the cost of STAR+PLUS long-term care and CAS received at age 55+ from the <b>probate estate</b> after death (1 TAC Chapter 373; HHSC "Your Guide to MERP"). No claim is filed while a spouse survives. The cousin, as a daughter, gets <b>no</b> caregiver-child exemption. These are the tools that work:'),
        table(['Tool', 'What it does', 'How'], [
            ['<b>Transfer on Death Deed</b> (Tex. Est. Code ch. 114) or Lady Bird deed', 'Passes the home outside probate. MERP claims only against the probate estate (1 TAC 373.105), so a recorded TODD keeps the home out of reach under current HHSC practice. Caveat: Est. Code 114.106 lets a personal representative reach TODD property within 2 years of death if the probate estate cannot pay claims, so keep other probate assets minimal and get attorney advice. Not a penalized transfer during life (MEPD I-3100). Revocable.', 'Free statutory form and instructions at TexasLawHelp.org; both owners sign; record it with the county clerk (about $30) before death or it is void (114.055). Do it this week while both are competent.'],
            ...
            ['<b>Undue hardship waiver</b> (1 TAC 373.209; Form 5006)', 'No recovery if the homestead is appraised under $100,000 and the heirs\' income is below 300% of poverty (about $47,880 single / $64,920 couple in 2026), but that homestead ground is only for heirs who are <b>siblings or lineal descendants</b> (children, grandchildren), so it does not help a daughter. The other grounds (recovery would push heirs onto public assistance; other compelling reasons) are open to anyone.', 'Request within 60 days of Form 8001; decided in 40 days.'],
            ['Automatic exemptions', 'No claim if the estate is $10,000 or less, the Medicaid cost is $3,000 or less, or there is a surviving spouse, a child under 21, a blind or permanently disabled child of any age, or an unmarried adult child who lived in the home full-time for at least a year before death.', 'MERP contractor <b>800-641-9356</b>; merp@hhs.texas.gov'],
        ...
        callout('Apply for BOTH spouses. Each one who qualifies is a separate assessment and a separate set of paid hours. Under CAS that is up to 100 hours a week for the household; under STAR+PLUS HCBS the 50-hour CAS cap does not apply and hours are bounded by the 202% cost ceiling. Getting the second spouse eligible is the single biggest pay lever in this plan.', 'money', 'The biggest lever'),
    ]
