...
def care():
    return [
        ...
        table(['Training', 'Where', 'Cost', 'Why it matters'], [
            ['Family Caregiver Support Program (Title III-E): caregiver education, counseling, support groups, respite vouchers', 'Local Area Agency on Aging, <b>800-252-9240</b>. A daughter caring for an aunt or uncle 60+ is an eligible caregiver (AAA Caregiver Eligibility Guide, Appendix VI).', 'Free', 'Enrolls you as the recognized family caregiver and unlocks vouchers'],
        ...
        bullets([
            '<b>STAR+PLUS HCBS respite:</b> up to <b>30 days (720 hours) per person per ISP year</b>, in-home or out-of-home (STAR+PLUS Handbook 7300). HHSC\'s CDS program page lists in-home respite as a CDS-deliverable service, so the employer can hire the respite worker, but that worker <b>must not live with the member</b> (7300). Respite exists to relieve unpaid caregiving (nights, weekends), so document those unpaid hours.',
        ...
        table(['An unlicensed attendant MAY do (with written RN delegation, or as a "health maintenance activity" the client can direct)', 'An unlicensed attendant may NEVER do'], [
            ['Oral, sublingual, topical, eye, ear, nose and inhaler medications; pill-organizer medications (225.11); insulin and other diabetes injections under the specific rules of 225.12; intermittent catheterization; tube irrigation; tracheostomy care and suctioning; routine oxygen; vital signs and glucose checks (225.8, 225.10). Medications through a feeding tube are prohibited except the narrow exception in 225.10(10).',
        ...
        table(['Problem', 'Call', 'Notes'], [
            ...
            ['Denied or reduced hours or items', 'STAR+PLUS: MCO appeal within <b>60 days</b>, continuation of benefits if requested within <b>10 days</b>, State Fair Hearing within <b>120 days</b> of the MCO decision (42 CFR 438). CAS and HCBS eligibility notices (Forms 2065-A, H2065-D): fair hearing within <b>90 days</b>, and before the effective date to keep services (CCSE 2900; PSU 7200).', 'Decision within 90 days. Appeal every low authorization.'],
