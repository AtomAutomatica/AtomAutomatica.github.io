...
def pitfalls():
    return [
        ...
        table(['Mistake', 'What it costs', 'The rule', 'Do this instead'], [
            ...
            ['Letting the assessor record the cousin as an available unpaid caregiver, answering "we manage fine," or quitting her job months before applying', 'Tasks coded "C" are not purchased; a caregiver who left work more than 30 days before or after the application date can be treated as available unpaid help', 'CCSE 2433, 2433.2; Forms 1583 and 1726', 'State that unpaid help is not available; time the resignation inside the 30-day window; the cousin is the hired attendant'],
            ['Paying the cousin cash, back pay, or "under the table" before approval; adding her to the deed or accounts', 'Transfer penalty: $262.37 per day of ineligibility; a $20,000 gift = 76 days', 'MEPD I-1000, I-4140, I-5100', 'Written prospective Personal Care Agreement, checks, logs; Transfer on Death Deed instead of a deed change'],
            ...
            ['Missing the HHSC interest-list contact or Form H2118', 'Removed from the list; start over at the bottom (44.6% of closures Sept. 2025 to July 2026 were "no response")', '1 TAC 353.1153; PSU Handbook 3300', 'Answer within 30 days; keep address and phone current'],
            ...
            ['Physician does not sign the MN/LOC or Form 3052, or charts only "dementia"', '617 medical-necessity denials and 251 "unable to obtain MD signature" closures, Sept. 2025 to July 2026', 'PSU 1250; CCSE 4600', 'Line up a responsive PCP now; ask for physical conditions causing the limits'],
            ...
            ['Not appealing low hours, or appealing late', 'Hours stay low; benefits stop during appeal', 'CCSE 2900 (90 days, before the effective date to keep services); MCO 60 days with continuation within 10 days (42 CFR 438.420)', 'Appeal every low authorization; ask for continuation'],
